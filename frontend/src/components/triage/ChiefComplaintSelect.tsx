...
export function ChiefComplaintSelect({
  ...
  const selectedLabel =
    CHIEF_COMPLAINTS.find((c) => c.value === value)?.label ?? "";
  ...
  function handleSelect(complaint: (typeof CHIEF_COMPLAINTS)[0]) {
    onChange(complaint.value);
    setQuery("");
    setOpen(false);
  }
    ...
    <div ref={containerRef} className="relative">
      ...
      >
        <input
          ref={inputRef}
          type="text"
          className="flex-1 outline-none placeholder:text-slate-400 bg-transparent"
          placeholder={value ? selectedLabel : "Search chief complaint..."}
